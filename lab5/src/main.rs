...
fn encode_base_16(input_path: &str, output_path: &str) -> Result<(), std::io::Error>
{
...
fn decode_base_16(input_path: &str, output_path: &str) -> Result<(), std::io::Error>
{
    let mut fd = File::create(output_path)?;
    return read_file(input_path, |buf: &[u8]| -> Result<(), std::io::Error> {
        assert!(buf.len() % 2 == 0);
...
fn main() {
    //let res = encode_base_16(r"D:\personal\RustLabs\RustLearning2023\lab5\res\otto_laptoasa.jpg", 
    //r"D:\personal\RustLabs\RustLearning2023\lab5\res\otto_laptoasa.txt");

    let res = decode_base_16(r"D:\personal\RustLabs\RustLearning2023\lab5\res\otto_laptoasa.txt", 
    r"D:\personal\RustLabs\RustLearning2023\lab5\res\otto_laptoasa_converted.png");
